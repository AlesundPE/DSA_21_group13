def destReceive(data):
    ...
    return contribution
import findspark
findspark.init("G:\\Current Courses\\DSA\\spark-3.1.1-bin-hadoop2.7") # you need to specify the path to PySpark here.
from pyspark import SparkContext
import time
iteration = 5
total_time = []
sc = SparkContext(appName = "PageRank")
lines = sc.textFile("G:\\Current Courses\\DSA\\DataProject\\graph640000") # you need to change the path to graph here
